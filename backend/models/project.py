...
class Project(db.Model):
    ...
    export_inpaint_method = db.Column(db.String(50), nullable=True, default='generative')  # 背景图获取方法: generative, baidu, hybrid
    ...
    def to_dict(self, include_pages=False):
        ...
        data = {
            ...
            'export_inpaint_method': self.export_inpaint_method or 'generative',
